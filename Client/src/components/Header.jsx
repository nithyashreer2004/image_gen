...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 -y-1 
    ...
    transition={{delay : 0.2 ,duration:0.8}}>
      ...
      <motion.h1 className='text-4xl max-w-75 sm:text-7xl sm:max-w- 147.5 max-auto mt-10 text-center ' >
        ...
        >Unleash your creativity with AI.Turn your 
           ...
           just tyoe,and watch the magic happen</motion.p>
           ...
           >Generate Images 
            ...
            className='mt-2 text-neutral-600'>Generator images from imagify</motion.p>
    </motion.div>
  )
}
